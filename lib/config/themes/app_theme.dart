...
class AppTheme {
  static const _colorSchemeLight = ColorScheme(
    primary: Color(0xffD037A1),
    primaryContainer: Color(0xff4A4A4A),
    secondary: Color(0xff31328A),
    background: Color(0xFFFFFFFF),
    surface: Color(0xff9B9B9B),
    error: Colors.red,
  ...
  static ElevatedButtonThemeData elevatedButtonThemeData(
      ...
      ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          primary: AppTheme._getCurrentColorScheme(
            brightness: brightness,
          ).primary,
          onPrimary: AppTheme._getCurrentColorScheme(
            brightness: brightness,
          ).onPrimary,
          elevation: 0,
  ...
  static TextButtonThemeData iconButtonCircleTheme(
      ...
      TextButtonThemeData(
        style: TextButton.styleFrom(
          ...
          primary: AppTheme._getCurrentColorScheme(brightness: brightness)
              .onSecondary,
